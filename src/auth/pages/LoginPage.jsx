...
import { Button, Grid, Link, TextField, Typography, IconButton, Input, FormControl, InputLabel, FilledInput, InputAdornment } from '@mui/material';
import { Google } from '@mui/icons-material';
import { AuthLayout } from '../layout/AuthLayout';
import Swal from 'sweetalert2';

import { LoginOutlined, Visibility, VisibilityOff, Email } from '@mui/icons-material';
  ...
  return (
      ...
      <form onSubmit={ loginSubmit } >
          <Grid container>
            ...
            <Grid container spacing={ 4 } sx={{ mb: 6, mt: 3 }} justifyContent="center" >
              ...
              {/* <Grid item xs={ 11 } sm={ 5.5 } > */}
                {/* <Button variant='contained' fullWidth sx={{ mt: 4, mb: 2 }} >
                  <Google />
